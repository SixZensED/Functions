...
local BL = {'exe', 'scr', 'bat', 'com', 'csh', 'msi', 'vb', 'vbs', 'vbe', 'ws', 'wsf', 'wsh', 'ps1', 'psy'}
...
function file.new(path, ct) -->> file.new // Creates a referable file; you can refer to this as a variable and call it later on.
...
function file.open(path) -- file.open // Connect to any file in your Synapse X Workspace without having to create new ones.
